...
var ValidationMessages = map[string]string{
	...
	"enum":         "invalid option; accepts {param}",
	"enum unknown": "the enum {param} was never registered",
...
func UseValidationPTBR() {
	ValidationMessages = map[string]string{
		...
		"enum":         "valor inválido; aceita {param}",
		"enum unknown": "o enum {param} nunca foi registrado",
		"eqfield":      "não confere",
