...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		...
		{"cookbook", "Cookbook", []string{"", "admin-app", "database", "sessions", "uploads", "csv", "wizard", "public-link", "files", "pagination", "email", "tasks", "webhooks", "scheduled-tasks", "docker", "production-checklist", "existing-api", "api-as-tools", "ai-chat", "ai-agent", "third-party-api", "listing", "migration", "from-next", "react-island"}},
	}},
	{Code: "pt", Prefix: "/pt", Lang: "pt-BR", Name: "Português", Sections: []Section{
		...
		{"receitas", "Receitas", []string{"", "app-administravel", "banco-de-dados", "sessoes", "uploads", "planilhas", "formulario-em-passos", "link-publico", "arquivos", "paginacao", "email", "tarefas", "webhooks", "tarefas-agendadas", "docker", "checklist-de-producao", "api-existente", "api-como-ferramentas", "chat-de-ia", "agente-de-ia", "api-de-terceiros", "listagem", "migracao", "do-next", "ilha-react"}},
	}},
}
