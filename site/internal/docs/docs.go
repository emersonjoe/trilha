...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		...
		{"reference", "Reference", []string{"", "conventions", "ctx", "h", "tmpl", "errors", "validation", "app", "security", "observability", "auth", "mail", "task", "approval", "webhook", "upstreams", "cache", "ui", "shell", "charts", "listings", "live", "ai", "mcp", "cli", "performance"}},
	...
	{Code: "pt", Prefix: "/pt", Lang: "pt-BR", Name: "Português", Sections: []Section{
		...
		{"referencia", "Referência", []string{"", "convencoes", "ctx", "h", "tmpl", "erros", "validacao", "app", "seguranca", "observabilidade", "auth", "mail", "task", "approval", "webhook", "upstreams", "cache", "ui", "shell", "graficos", "listagens", "vivo", "ai", "mcp", "cli", "desempenho"}},
