...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		...
		{"cookbook", "Cookbook", []string{"", "database", "sessions", "uploads", "pagination", "email", "scheduled-tasks", "docker", "production-checklist", "existing-api", "listing", "migration", "from-next"}},
	}},
	{Code: "pt", Prefix: "/pt", Lang: "pt-BR", Name: "Português", Sections: []Section{
		...
		{"receitas", "Receitas", []string{"", "banco-de-dados", "sessoes", "uploads", "paginacao", "email", "tarefas-agendadas", "docker", "checklist-de-producao", "api-existente", "listagem", "migracao", "do-next"}},
	}},
}
