...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		{"learn", "Learn", []string{"", "pages-and-routes", "layouts", "html-with-h", "forms", "api", "data", "middleware", "security", "observability", "authentication", "ui-kit", "ui-screens", "interactivity", "the-ceiling", "from-htmx-and-templ", "ai-and-agents", "agentic-protocol", "agentic-runner", "agentic-cloud", "examples", "testing", "dev-and-production", "troubleshooting"}},
		...
		{"cookbook", "Cookbook", []string{"", "admin-app", "database", "sessions", "uploads", "csv", "wizard", "public-link", "files", "pagination", "email", "tasks", "webhooks", "scheduled-tasks", "pwa", "docker", "production-checklist", "existing-api", "api-as-tools", "ai-chat", "ai-agent", "third-party-api", "listing", "migration", "from-next", "react-island"}},
	}},
	{Code: "pt", Prefix: "/pt", Lang: "pt-BR", Name: "Português", Sections: []Section{
		{"aprender", "Aprender", []string{"", "paginas-e-rotas", "layouts", "html-com-h", "formularios", "api", "dados", "middleware", "seguranca", "observabilidade", "autenticacao", "interface-com-ui", "telas-prontas", "interatividade", "o-teto", "vindo-do-htmx-e-templ", "ia-e-agentes", "agentico-protocolo", "agentico-runner", "agentico-cloud", "exemplos", "testes", "dev-e-producao", "problemas-comuns"}},
		...
		{"receitas", "Receitas", []string{"", "app-administravel", "banco-de-dados", "sessoes", "uploads", "planilhas", "formulario-em-passos", "link-publico", "arquivos", "paginacao", "email", "tarefas", "webhooks", "tarefas-agendadas", "pwa", "docker", "checklist-de-producao", "api-existente", "api-como-ferramentas", "chat-de-ia", "agente-de-ia", "api-de-terceiros", "listagem", "migracao", "do-next", "ilha-react"}},
	}},
}
