...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		...
		{"cookbook", "Cookbook", []string{"", "database", "sessions", "uploads", "csv", "wizard", "public-link", "pagination", "email", "scheduled-tasks", "docker", "production-checklist", "existing-api", "listing", "migration", "from-next", "react-island"}},
	}},
	{Code: "pt", Prefix: "/pt", Lang: "pt-BR", Name: "Português", Sections: []Section{
		...
		{"receitas", "Receitas", []string{"", "banco-de-dados", "sessoes", "uploads", "planilhas", "formulario-em-passos", "link-publico", "paginacao", "email", "tarefas-agendadas", "docker", "checklist-de-producao", "api-existente", "listagem", "migracao", "do-next", "ilha-react"}},
	}},
}
