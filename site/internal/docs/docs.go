...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		{"learn", "Learn", []string{"", "pages-and-routes", "layouts", "html-with-h", "forms", "api", "data", "middleware", "security", "observability", "authentication", "ui-kit", "ui-screens", "interactivity", "the-ceiling", "from-htmx-and-templ", "ai-and-agents", "examples", "testing", "dev-and-production", "troubleshooting"}},
	...
	{Code: "pt", Prefix: "/pt", Lang: "pt-BR", Name: "Português", Sections: []Section{
		{"aprender", "Aprender", []string{"", "paginas-e-rotas", "layouts", "html-com-h", "formularios", "api", "dados", "middleware", "seguranca", "observabilidade", "autenticacao", "interface-com-ui", "telas-prontas", "interatividade", "o-teto", "vindo-do-htmx-e-templ", "ia-e-agentes", "exemplos", "testes", "dev-e-producao", "problemas-comuns"}},
