...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		...
		{"cookbook", "Cookbook", []string{"", "database", "sessions", "uploads", "csv", "wizard", "public-link", "files", "pagination", "email", "tasks", "webhooks", "scheduled-tasks", "docker", "production-checklist", "existing-api", "api-as-tools", "ai-chat", "ai-agent", "third-party-api", "listing", "migration", "from-next", "react-island"}},
	}},
