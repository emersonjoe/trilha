...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		...
		{"reference", "Reference", []string{"", "conventions", "ctx", "h", "tmpl", "errors", "validation", "app", "security", "observability", "auth", "upstreams", "cache", "ui", "listings", "live", "ai", "mcp", "cli", "performance"}},
		{"cookbook", "Cookbook", []string{"", "database", "sessions", "uploads", "pagination", "email", "scheduled-tasks", "docker", "production-checklist", "existing-api", "listing", "migration"}},
	}},
	{Code: "pt", Prefix: "/pt", Lang: "pt-BR", Name: "Português", Sections: []Section{
		...
		{"referencia", "Referência", []string{"", "convencoes", "ctx", "h", "tmpl", "erros", "validacao", "app", "seguranca", "observabilidade", "auth", "upstreams", "cache", "ui", "listagens", "vivo", "ai", "mcp", "cli", "desempenho"}},
		{"receitas", "Receitas", []string{"", "banco-de-dados", "sessoes", "uploads", "paginacao", "email", "tarefas-agendadas", "docker", "checklist-de-producao", "api-existente", "listagem", "migracao"}},
	}},
}
