...
var Locales = []Locale{
	{Code: "en", Prefix: "", Lang: "en", Name: "English", Sections: []Section{
		...
		{"reference", "Reference", []string{"", "conventions", "ctx", "h", "tmpl", "errors", "validation", "app", "security", "observability", "auth", "mail", "upstreams", "cache", "ui", "shell", "charts", "listings", "live", "ai", "mcp", "cli", "performance"}},
		{"cookbook", "Cookbook", []string{"", "database", "sessions", "uploads", "csv", "wizard", "public-link", "files", "pagination", "email", "scheduled-tasks", "docker", "production-checklist", "existing-api", "listing", "migration", "from-next", "react-island"}},
	}},
	{Code: "pt", Prefix: "/pt", Lang: "pt-BR", Name: "Português", Sections: []Section{
		...
		{"referencia", "Referência", []string{"", "convencoes", "ctx", "h", "tmpl", "erros", "validacao", "app", "seguranca", "observabilidade", "auth", "mail", "upstreams", "cache", "ui", "shell", "graficos", "listagens", "vivo", "ai", "mcp", "cli", "desempenho"}},
		{"receitas", "Receitas", []string{"", "banco-de-dados", "sessoes", "uploads", "planilhas", "formulario-em-passos", "link-publico", "arquivos", "paginacao", "email", "tarefas-agendadas", "docker", "checklist-de-producao", "api-existente", "listagem", "migracao", "do-next", "ilha-react"}},
	}},
}
