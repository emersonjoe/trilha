...
func Maxlength(v string) Node    { return Attr("maxlength", v) }
func Minlength(v string) Node    { return Attr("minlength", v) }
func Autocomplete(v string) Node { return Attr("autocomplete", v) }
func Inputmode(v string) Node    { return Attr("inputmode", v) }
