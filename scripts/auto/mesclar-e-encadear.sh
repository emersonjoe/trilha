...
# encadeamento para aqui de propósito: enfileirar a próxima esconderia o problema. A label
# `auto` sai para o schedule não repetir a mesma issue de hora em hora.
...
if [ "${estado:-}" != "CLOSED" ]; then
	# A PR foi mesclada mas o "Closes" não pegou: fechar à mão é melhor que deixar a issue
	# aberta com o trabalho já na branch padrão.
