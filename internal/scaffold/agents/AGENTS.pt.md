...
| `trilha i18n extract [--write]` | as chaves que o `c.T` usa; `--write` acrescenta as que faltam no idioma padrão. O `trilha i18n missing <locale>` diz o que falta traduzir |
