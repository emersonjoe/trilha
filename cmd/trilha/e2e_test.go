...
func TestAddE2E(t *testing.T) {
	...
	for _, nome := range []string{"audit", "api-keys", "blob", "login", "mail", "permissions", "profile", "settings", "share-link", "tasks", "tenant", "users", "webhooks"} {
	...
	for _, nome := range []string{"audit", "settings", "api-keys", "login", "users", "permissions", "profile", "webhooks", "tasks", "mail", "blob", "share-link", "tenant"} {
