...
func TestAddE2E(t *testing.T) {
	...
	for _, nome := range []string{"audit", "api-keys", "login", "mail", "permissions", "profile", "settings", "tasks", "users", "webhooks"} {
	...
	for _, nome := range []string{"audit", "settings", "api-keys", "login", "users", "permissions", "profile", "webhooks", "tasks", "mail"} {
