...
`},
	...
	"generate usage":   {"usage: trilha generate page|route|test <url> | component <Name> | crud <Type> [--at dir] [--store sqlite|postgres] [--methods GET,POST] [--bind Type] [--form Type] [--layout file] [--force] [--dir path] [--lang en|pt]", "uso: trilha generate page|route|test <url> | component <Nome> | crud <Tipo> [--at dir] [--store sqlite|postgres] [--methods GET,POST] [--bind Tipo] [--form Tipo] [--layout arquivo] [--force] [--dir caminho] [--lang en|pt]"},
